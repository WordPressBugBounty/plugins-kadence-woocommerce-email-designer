...
class Kadence_Woomail_Designer {
	...
	public function on_plugins_loaded() {
		...
		define( 'KT_WOOMAIL_VERSION', '1.5.19.1' );
	...
	/**
	 * Checks to see if this is an authorized preview request
	 *
	 * @since 1.5.19.1
	 * @access public
	 * @return bool
	 */
	public static function is_authorized_preview_request() {
		return self::is_own_preview_request() && is_customize_preview() && is_user_logged_in() && self::is_admin();
	}
